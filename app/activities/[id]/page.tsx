        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-4xl font-black text-slate-900 mb-4">Activity Not Found</h1>
                    <Link href="/activities" className="text-red-600 font-bold hover:underline">
                        ← Back to Activities
                    </Link>
                </div>
            </div>
                                            ...
                                            <div className="flex items-center gap-3 flex-wrap">
                                                ...
                                                {activity.rating && (
                                                    <div className="flex items-center gap-1 px-3 py-1 bg-amber-50 rounded-lg">
                                                        ...
                                                        <span className="font-bold text-amber-700">{activity.rating}</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
