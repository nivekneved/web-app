      ...
      <section className="relative h-[60vh] flex items-center min-h-[400px]">
        ...
        <div className="container mx-auto px-4 relative z-10 text-white">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">World-Class Flight Experiences</h1>
            <p className="text-xl mb-8 text-white/90">Experience seamless travel with our premium flight booking services. From economy to first class, we ensure your journey is as smooth as your destination.</p>
            <Link 
              href="/contact"
