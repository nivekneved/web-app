      ...
      <section className="relative h-[65vh] flex items-center min-h-[500px]">
        ...
        <div className="container mx-auto px-4 relative z-10 text-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-7xl font-bold mb-6 italic font-serif">Hotel Day Experiences</h1>
            ...
            <Link 
              href="/contact"
              className="px-10 py-5 bg-primary text-black font-bold rounded-full hover:bg-primary/90 transition-all inline-block shadow-xl shadow-primary/20"
            >
              Enquire Now
            </Link>
          </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
             <div className="text-center mb-20 max-w-2xl mx-auto">
                ...
                <p className="text-lg text-slate-600">Our hotel day packages are designed to offer you a complete hotel experience without the overnight stay. Typical inclusions include:</p>
             </div>
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                {[
                    ...
                    { hotel: 'Maritim Resort & Spa', price: 'Rs 4,200', hours: 'All-Inclusive Day', location: 'Balaclava' },
                ].map((deal, i) => (
                    <div key={i} className="flex flex-col md:flex-row bg-white/5 border border-white/10 rounded-[2.5rem] overflow-hidden group">
                        <div className="md:w-1/2 relative h-64 md:h-auto border-r border-white/10">
                        ...
                        <div className="p-10 md:w-1/2">
                            ...
                            <div className="flex items-center justify-between mt-auto pt-6 border-t border-white/10">
                                ...
                                <Link href="/contact" className="px-6 py-2.5 bg-primary text-black font-bold rounded-full hover:bg-primary/90 transition-all text-sm">Enquire Now</Link>
                            </div>
                        </div>
                    </div>
                ))}
