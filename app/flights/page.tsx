        ...
        <div className="min-h-screen bg-slate-50 pb-20">
            ...
            <div className="container mx-auto px-4 py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        { to: "Dubai, UAE", price: "Rs 28,500", img: "/hero-flight.png" },
                        { to: "Paris, France", price: "Rs 42,000", img: "/hero-flight.png" }, // reusing
                        { to: "London, UK", price: "Rs 45,500", img: "/hero-flight.png" }, // reusing
                        { to: "Mumbai, India", price: "Rs 22,000", img: "/hero-flight.png" }, // reusing
                        { to: "Johannesburg, SA", price: "Rs 18,500", img: "/hero-flight.png" }, // reusing
                        { to: "Singapore", price: "Rs 38,000", img: "/hero-flight.png" } // reusing
                    ].map((dest, i) => (
                        <div key={i} className="group flex items-center gap-4 bg-white p-4 rounded-2xl shadow-sm hover:shadow-lg transition-all border border-slate-100">
                            <div className="w-20 h-20 relative rounded-xl overflow-hidden shrink-0">
                                <Image src={dest.img} alt={dest.to} fill className="object-cover" />
                            </div>
                            <div className="flex-1">
                                <h3 className="font-bold text-slate-900">{dest.to}</h3>
                                <p className="text-sm text-slate-400">Return from</p>
                                <p className="text-red-600 font-black">{dest.price}</p>
                            </div>
