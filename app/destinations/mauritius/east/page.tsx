...
export const metadata = {
    ...
    description: 'Discover the wild beauty and luxury resorts of the East Coast of Mauritius.',
}
...
export default function MauritiusEastPage() {
    return (
        <DestinationListing
            title="East Coast"
            subtitle="Home to the famous Ile aux Cerfs and some of the island's most exclusive luxury resorts."
