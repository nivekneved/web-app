      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
             <div className="max-w-4xl mx-auto mb-20 text-center">
                ...
                <p className="text-lg text-slate-600 leading-relaxed mb-6">Founded with a simple mission—to make every journey extraordinary—Travel Lounge began as a small family-run agency in the heart of Mauritius. Over the years, we have grown into a premier travel companion for thousands of explorers, yet our core values remain unchanged.</p>
                <p className="text-lg text-slate-600 leading-relaxed">We don&apos;t just book trips; we create memories. Our story is written by the smiles of our travelers and the countless sunrises seen across the globe.</p>
             </div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                 ...
                 <div className="space-y-12">
                    {[
                        { title: 'The Beginning', desc: 'Starting in 1995, we set out to redefine travel service in Mauritius, focusing on transparency and local expertise.', icon: History },
                        { title: 'Excellence Recognized', desc: 'Over two decades of awards and recognition from major airlines and international tourism boards.', icon: Award },
                        { title: 'Growing Community', desc: 'Today, we serve a global community, providing bespoke experiences from Port Louis to Paris.', icon: Users },
                    ].map((item, i) => (
