                                ...
                                <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <p className="text-sm font-medium text-slate-600">Secure Data Storage</p>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <CheckCircle2 size={18} className="text-green-500 mt-1 shrink-0" />
                                            <p className="text-sm font-medium text-slate-600">No Third-Party Sharing</p>
                                        </div>
                                        <div className="flex items-start gap-3">
                                            <CheckCircle2 size={18} className="text-green-500 mt-1 shrink-0" />
                                            <p className="text-sm font-medium text-slate-600">24/7 Monitoring</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="text-center p-6 bg-red-50 rounded-3xl border border-red-100">
                                    <p className="text-xs font-black text-red-900 uppercase tracking-widest mb-1">Last Updated</p>
                                    <p className="text-sm font-bold text-red-600">{hero.last_updated}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            {sections.map((section, i) => (
                                ...
                                >
                                    <h2 className="text-2xl font-black text-slate-900 mb-6 flex items-center gap-4">
                                        <span className="w-8 h-8 rounded-lg bg-red-600 text-white text-[10px] font-black flex items-center justify-center">0{i+1}</span>
                                        {section.title}
                                    </h2>
