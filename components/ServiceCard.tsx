...
export default function ServiceCard({ title, location, price, image, duration, link, tag }: ServiceCardProps) {
    return (
        <motion.div
        ...
        >
            ...
            <div className="p-6 flex flex-col flex-1">
                ...
                <div className="mt-auto flex items-end justify-between border-t border-slate-100 pt-4">
                    ...
                    <Link href={link} className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-900 group-hover:bg-red-600 group-hover:text-white transition-all">
                        <ArrowRight size={18} />
                    </Link>
                </div>
            </div>
